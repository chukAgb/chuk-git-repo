...
def print_menu(cart):
    ...
    while True:
        ...
        if choice == 'q':
            ...
            print("REMOVE ITEM FROM CART")  # Added prompt for removing item from cart
            name = input("Enter name of item to remove: ")  # Prompt for item name to remove
            cart.remove_item(name)  # Remove item from cart
        elif choice == 'c':
